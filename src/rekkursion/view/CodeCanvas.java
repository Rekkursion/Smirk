...
//    private Point2D mMouseDownPt = null;
//
//    /* ===================================================================== */
//
...
//                mMouseDownPt = new Point2D(mouseEvent.getX(), mouseEvent.getY());
//                handleMouseDown(mouseEvent.getX(), mouseEvent.getY());
//            }
//        });
//
//        // mouse-moved
...
//
//        // mouse-released
//        setOnMouseReleased(mouseEvent -> mMouseDownPt = null);
//
//        // key-pressed
...
//    private void handleMouseDown(double mouseX, double mouseY) {
...
//        mCaretOffset = Math.min(
//            mTextBuffers.get(mCaretLineIdx).length(),
//            (int) Math.round(mouseX / CHARA_WIDTH)
//        );
//
...
//            mTextBuffers.get(mCaretLineIdx).insert(mCaretOffset, getVisibleChar(ch));
//
...
//    private char getVisibleChar(String ch) {
//        if (!mIsShiftPressed)
//            return ch.charAt(0);
